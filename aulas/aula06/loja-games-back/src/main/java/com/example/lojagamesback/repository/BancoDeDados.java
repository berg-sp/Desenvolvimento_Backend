...
public class BancoDeDados {
    ...
    public BancoDeDados() {
        jogos.add(new Jogo(1, "Fire emblem Rekka no ken", "RPG Tático", 60.00,
                "https://bdjogos.com.br/capas/3932-Fire-Emblem-Game-Boy%20Advance-capa-1.jpg"));

        jogos.add(new Jogo(2, "Fire emblem Sealed swords", "RPG Tático", 60.00,
        ...
        jogos.add(new Jogo(3, "Fire emblem Sacred stones", "RPG Tático", 60.00,
                "https://amostagreeablepastime.files.wordpress.com/2016/12/fire-emblem-sacred-stones-cover-art-gba.jpg"));
    }
